...
3. Navigate to maincourse_java_jfse_mc05_k8s_rollingout_rollback_springboot_exercise folder

    `cd maincourse_java_jfse_mc05_k8s_rollingout_rollback_springboot_exercise`
